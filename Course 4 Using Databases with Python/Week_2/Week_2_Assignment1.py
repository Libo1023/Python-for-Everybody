...
# Then, create a SQLITE database or use an existing database and 
...
DELETE FROM Ages;
INSERT INTO Ages (name, age) VALUES ('Amara', 17);
INSERT INTO Ages (name, age) VALUES ('Alice', 18);
INSERT INTO Ages (name, age) VALUES ('Sia', 32);
INSERT INTO Ages (name, age) VALUES ('Chanel', 14);
