...
# and compute the average of those values and produce an output as shown
...
for line in fh :
	if line.startswith("X-DSPAM-Confidence:") :
		count = count + 1
		data_pos = line.find('0')
		data_string = line[data_pos:]
		data_float = float(data_string)
		data_total = data_total + data_float

data_average = data_total / count

print('Average spam confidence:', data_average)